...
VALUES ('DELL inspiron 6200', 'ordinateur 4Go de RAM, disque SSD 120Go, écran 17 pouce, windows installé', getdate(), getdate()+30, 250,null,1,1,'créer');
INSERT INTO [dbo].[BID_ITEMS]([name],[description],[dateStart],[dateEnd],[priceSeller],[priceBuyer],[userIdSeller],[cateId],[status])
VALUES ('DELL inspiron 6300', 'ordinateur 4Go de RAM, disque SSD 120Go, écran 17 pouce, windows installé', getdate(), getdate()+30, 250,null,1,1,'annuler');
INSERT INTO [dbo].[BID_ITEMS]([name],[description],[dateStart],[dateEnd],[priceSeller],[priceBuyer],[userIdSeller],[cateId],[status])
...
INSERT INTO [dbo].[BID_ITEMS]([name],[description],[dateStart],[dateEnd],[priceSeller],[priceBuyer],[userIdSeller],[cateId],[status])
VALUES ('DELL inspiron 6500', 'ordinateur 4Go de RAM, disque SSD 120Go, écran 17 pouce, windows installé', getdate(), getdate()+30, 250,null,1,1,'terminées');
INSERT INTO [dbo].[BID_ITEMS]([name],[description],[dateStart],[dateEnd],[priceSeller],[priceBuyer],[userIdSeller],[cateId],[status])
VALUES ('DELL inspiron 6600', 'ordinateur 4Go de RAM, disque SSD 120Go, écran 17 pouce, windows installé', getdate(), getdate()+30, 250,null,1,1,'retiré');
INSERT INTO [dbo].[BID_ITEMS]([name],[description],[dateStart],[dateEnd],[priceSeller],[priceBuyer],[userIdSeller],[cateId],[status])
